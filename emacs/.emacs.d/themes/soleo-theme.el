...
(let ((base00 "#1f2d3a")  ;;BG 
  ...
  (custom-theme-set-faces 
   ...
   ;; Clojure errors
   `(clojure-soleo-failure-face ((t (:background nil :inherit flymake-warnline))))
   `(clojure-soleo-error-face ((t (:background nil :inherit flymake-errline))))
   `(clojure-soleo-success-face ((t (:background nil :foreground nil :underline ,base0B))))
